...
destinationRouter.post("/add-destination", requireAuth, requireAdmin, addDestination);       // This endpoint is called when Admin adds a destination to the list of available destinations
